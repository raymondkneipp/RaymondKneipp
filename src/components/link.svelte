<script>
  ...
  const colors = light
    ? "text-blue-400 focus:ring-blue-400 focus:ring-offset-gray-900"
    : "text-blue-600 focus:ring-blue-600 focus:ring-offset-white";
</script>
...
>
  ...
  {#if arrow}
    <svg
      ...
      class="h-5 w-5 group-hover:ml-2 transition-all"
      fill="none"
      viewBox="0 0 24 24"
      stroke="currentColor"
    >
